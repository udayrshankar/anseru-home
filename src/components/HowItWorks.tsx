      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="space-y-6 text-center md:text-left">
            <p className="text-sm font-medium text-gray-500 uppercase tracking-widest">How it Works</p>
          ...
          <div className="gradient-a3 rounded-2xl p-8 md:p-12 text-white min-h-[350px] md:min-h-[450px] flex flex-col justify-between relative overflow-hidden shadow-lg">
            ...
            <div className="relative z-10 space-y-4">
              <p className="text-xs md:text-sm font-medium uppercase tracking-widest opacity-90">Ask. Find. Respond—instantly.</p>
            ...
            <div className="relative mt-8 translate-y-4 md:translate-y-15 md:translate-x-15 z-10">
              <img src={intro} alt="Anseru Interface" className="w-full h-auto rounded-lg shadow-2xl" />
            </div>
          </div>
        </div>
      </div>
