...
export default function TwoAgents() {
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    const continuousIndex = latest; // only 0 to 1
  ...
  return (
    <div ref={targetRef} className="w-full bg-white pb-7 relative h-[200vh]">
      <div className="max-w-[1200px] mx-auto px-6 w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-xl">
            ...
            >
              Meet Archer
              <img src={knoxIcon} alt="archer" width="16" height="16" />
            </button>
                  ...
                  <div className="lg:w-[48%] p-3.5 bg-white border lg:border-b-0 lg:border-r border-[#e5e7eb] flex-shrink-0">
                    ...
                    >
                      ...
                      <div className="relative mt-auto">
                        <h3 className="anseru-card-title text-white mb-4">
                          {agent.title}
                        </h3>
