  ...
  return (
    <div className="w-full flex flex-col font-[Inter]">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative flex items-center justify-center min-h-[420px] md:min-h-[520px] overflow-hidden">
          ...
          <div className="relative z-10 bg-white/10 border border-white/20 rounded-xl p-10 space-y-5 w-full max-w-[480px] shadow-2xl translate-x-30">
            ...
            {[
              ...
              <div
                key={i}
                className="border border-white/40 bg-white/10 text-white px-6 py-2 rounded-md text-[18px] tracking-wide"
              >
                {item}
              </div>
            ))}
        ...
        <div className="bg-[#f4f4f4] flex items-center">
          <div className="max-w-xl px-10 md:px-14 space-y-10 py-16 md:py-0">
            ...
            <h2 className="anseru-section-title pb-18 mb-8">
              <span className="text-gray-700 text-5xl">The New Layer for</span> <br />
              <span className="text-blue-600 text-5xl font-medium">Enterprise Deals</span>
            </h2>

            <div className="border-l-[2px] border-gray-300 pl-6 max-w-[420px] ml-30">
              <p className="text-gray-600 text-[15px] leading-[1.7]">
                We’re building a world where AI agents orchestrate complex deal workflows,
                transforming enterprise knowledge into deal-ready intelligence so teams
      ...
      <div className="w-full bg-[#f4f4f4] border-t border-gray-200 py-20 px-10 md:px-14 flex flex-col items-center justify-center text-center gap-8">
        ...
        <h2 className="font-regular text-2xl md:text-5xl max-w-none whitespace-nowrap">
            Deal Intelligent Infrastructure for Modern Sales teams
        </h2>

        <button style= {{fontFamily : "DM sans"}} className="bg-black text-white px-10 py-3 rounded-md text-[20px] hover:bg-gray-800 transition shadow-sm shrink-0">
          Talk to Founders
        </button>
